...
CPPFLAGS = -I/home/dyy/kingbasedci/include 
CSCOPE = cscope
CTAGS = ctags
CXX = g++
CXXCPP = g++ -E
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DBCPPFLAGS =  -I/home/dyy/kingbasedci/include 
DBLDFLAGS =  -L/usr/lib/x86_64-linux-gnu -ldcikdb -lpthread -lm -lrt -latomic -ldl
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
DSYMUTIL = 
...
LDFLAGS = -L/usr/lib/x86_64-linux-gnu -ldcikdb -lpthread -lm -lrt -latomic -ldl 
LEX = flex
LEXLIB = 
